...
class MovieCaseSerializer(ElementFieldMixin, serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = MovieCase
        fields = ["id","custom_id_display","name","id_barcode","format_disk","subformat_disk","nb_disk","custom_id_generic","ean", "barcode_effective", "category_box","category_box_display","borrow_history","quantity_owned","quantity_available","is_new","type"] #ElementSerializer.Meta.fields
        depth = 1
